...
<legend>BUSQUEDA DE DEMANDADOS</legend>
<table border="0" align="center">
	...
	<tr>
		...
		<td valign="top">		
			<% int i=0;%>
			<display:table id="results" name="listaDemandados" requestURI="/demandadoList.htm" pagesize="5"
	            ...
	            <c:url var="editCcUrl" value="addDemandado.htm">
				   <c:param name="idDemandado" value="${results.idDemandado}" />
				</c:url>
